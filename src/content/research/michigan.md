...
From 2010-2015, I attended the University of Michigan where I earned my M.S. and Ph.D. in statistical signal processing. My research focused on multi-modal data fusion, particularly high-dimensional sample-starved applications. I applied recent advances in random matrix theory to derive fundamental limits of classical algorithms and to propose improved versions of those algorithms. My advisor was <a class="inline-link" href="https://web.eecs.umich.edu/~rajnrao/" target="_blank" rel="noopener noreferrer">Prof. Raj Nadakuditi</a>.
...
[All Papers Repository](https://github.com/asendorf/papers)
...
[Paper Repository](https://github.com/asendorf/papers/tree/master/2015_thesis)

[View Paper](https://deepblue.lib.umich.edu/handle/2027.42/113419)
...
[Paper Repository](https://github.com/asendorf/papers/tree/master/2015_ieee_tit)

[View Paper](https://ieeexplore.ieee.org/abstract/document/7903598)
...
[Paper Repository](https://github.com/asendorf/papers/tree/master/2013_ieee_tsp)

[View Paper](https://ieeexplore.ieee.org/abstract/document/6415288)
